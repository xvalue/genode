                  ...
                  unsigned const s, unsigned const q)
{
	...
	if (hs != share(s)) {
		...
		Genode::log("wrong share ", hi, " in line ", l, " expected ", s);
		//done();
	}
	if (hq != q) {
...
void Component::construct(Genode::Env &)
{
	 ...
	 *      fresh time-slice. The current replenishments timings are separated
     *      by |. The string 1'100 | 500-100 | 1000-30 | means: claim 1 has 100
     *      quota left and after 500 time units, it receives 100 quota, and
     *      after 1000 time units claim 1 receives 30 quota.
     *
	 *
	...
	A(1) U( 10, 750, 1, 100) /* 1'0 - 1'100 */
         ...
         U(50,   0, 1, 50) /* 1'230 - 1'100 */

	/* third round - one claim per priority */
	C(2) A(2) U( 10,  10, 2, 170) /* 1'30 - 2'170 - 1'100 2 */
	     I(1) U( 70, 80, 2, 100) /* 1°110 - 2'170 - 2'100 */
	A(1) I(2) U(110, 180, 1, 100) /* 1'110 - 2°60 - 1'100 */
	          U( 90, 270, 1,  200) /* 1'20 - 2°60 - 1'100 */
	A(2) I(1) U( 10, 280, 2,  100) /* 1°10 - 2'60 - 2'100 */
	     C(3) U( 40, 320, 2,  60) /* 3°110 - 1°10 - 2'10 - 2'100 */
	     A(3) U( 10, 330, 3, 110) /* 3'110 - 1°10 - 2'10 - 2'100 3 */
	          U(150, 440, 2,  50) /* 3'0 - 1°10 - 2'10 - 2'100 3 */
	          U( 10, 450, 2, 40) /* 3'0 - 1°10 - 2'0 - 2'100 3 */
	          U( 60, 490, 3,  100) /* 3'0 - 1°10 - 2'0 - 2'40 3 */
	     C(4) U( 60, 550, 3, 40) /* 3'0 - 1°10 - 4°90 - 2'0 - 3'100 2 */
	C(6) A(6) U(120, 590, 2, 100) /* 3'0 - 1°10 - 4°90 - 2'0 - 2'100 6 3*/
	     A(4) U( 80, 670, 4,  90) /* 3'0 - 1°10 - 4'90 - 2'0 - 2'20 6 3 4 */
	I(4) A(1) U( 50, 720, 1,  220) /* 3'0 - 1'10 - 4°40 - 2'0 - 2'20 6 3 1 */
	          U( 50, 770, 1,  170) /* 3'0 - 1'0 - 4°40 - 2'0 - 2'20 6 3 1 */
	          U( 50, 820, 1, 120) /* 3'0 - 1'0 - 4°40 - 2'0 - 6'100 3 1 2 */
	          U(100, 920, 1,  20) /* 3'0 - 1'0 - 4°40 - 2'0 - 3'100 1 2 6 */
	          U( 80, 940, 2, 20) /* 3'110 - 1'230 - 4°40 - 2'170 - 3'60 1 2 6 */
	          U( 60, 960, 6, 100) /* 3'110 - 1'230 - 4°40 - 2'170 - 3'60 1 2 6 */
	          U( 60, 0, 6, 40) /* 3'110 - 1'230 - 4°40 - 2'170 - 3'60 1 2 6 */

	/* fourth round - multiple claims per priority */
	     C(5) U( 40,  40, 3,  100) /* 3'50 5°120 - 1'230 - 4°90 - 2'170 - 3'60 1 2 6 */
	A(4) I(3) U( 60, 100, 4, 40) /* 3°10 5°120 - 1'230 - 4'90 - 2'170 - 1'100 2 6 4 */
